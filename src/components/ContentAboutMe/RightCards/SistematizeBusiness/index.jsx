...
function  SistematizeBusiness() {
  return (
    <div className="col-start-1 col-end-2 w-72 h-[350px] bg-cover rounded-xl flex flex-col justify-evenly items-center text-primary text-center font-semibold"  style={{ backgroundImage: `url(${figure})`}}>
